...
// Constructor
DoublyCll ::DoublyCll() : Head(NULL), Tail(NULL), size(0) {}

// Functions definations
void DoublyCll ::InsertAtFirst(int iNo) // try
{
    // Memory allocation
    PNODE newN = new NODE();
...
void DoublyCll ::InsertAtLast(int iNo)
{
    PNODE temp = Head;
...
void DoublyCll :: DisplayBackward()
{
    PNODE temp = Tail;
