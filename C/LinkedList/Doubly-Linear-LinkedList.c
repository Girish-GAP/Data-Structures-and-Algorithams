...
//                                                                                            //
//  Description :  This application performs all operations of singly Doubly-Linear-LL        //
...
/*
    ...
    START
        ...
        @old first prev insert address of newN,
...
/*
    ...
    START
        ...
        Insert the address of last element in privious of new.
    STOP
*/
void InsertAtLast(
    PPNODE Head, // Gives the address of Head pointer in which the address of first node of linkedList is stored.
...
/*
    ...
    START
        ...
        Insert newN address in after pos node of privious.
        Insert newN address in Privious node next.
        Insert address of after pos node in newn->next.
        Insert privious node address in newN-> previous
    STOP
*/
BOOL InsertAtPos(
    PPNODE Head, // Gives the address of Head pointer in which the address of first node of linkedList is stored.
...
/*
    ...
    START
        ...
        Insert Null in privoius of 2nd node.
...
/*
    ...
    START
        ...
        Insert the address of Privous pos in after pos privious.
    STOP
*/
BOOL DeleteAtPos(
    PPNODE Head, // Gives the address of Head pointer in which the address of first node of linkedList is stored.
