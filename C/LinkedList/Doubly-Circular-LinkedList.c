...
//                                                                                            //
//  Description :  This application performs all operations of Doubly linked list.            //
...
//
//  Strcture name :     node
//  Data :              intiger, struct node * , struct node *
...
/*
    ...
    START
        ...
        @Head (2nd node) privious insert address of newN,
        @Head insert address of newN as first node.
...
/*
    ...
    START
        ...
        Insert address of last node in privious of newN.
...
//  Input :             struct node **, struct node **, Intiger, Intiger
//  Output :            void
...
/*
    ...
    START
        ...
        If pos is last node then simpley insert at last and return.
        Insert address of newN in privious pos node next.
        Insert address of privious pos in newN->privious.
        Insert address of newN in after pos privious.
        Insert address of after pos in next of newN.
    STOP
*/
BOOL InsertAtPos(PPNODE Head, PPNODE Tail, int iNo, int iPos)
{
...
/*
    ...
    START
        ...
        @2nd node privious initilize NULL.
...
/*
    ...
    START
        ...
        @second last element next insert address of head.
...
{
    PNODE target = (*Tail)->prev; // second last node
    PNODE temp = (*Tail);  // last node
...
/*
    ...
    START
        ...
        Insert the address of privous pos node in privious of after pos node.
    STOP
*/
BOOL DeleteAtPos(       
                        PPNODE Head,    // Gives the address of first node of linkedList.        
                    ...
                    )
{
    ...
    PNODE beforePos = *Head;    // for traverse until beofore ipos node
    PNODE afterPos = NULL;  // node after Pos
    PNODE Pos = NULL;       // Position node
    ...
    else
    {
        ...
        for (int i = 1; i < iPos - 1; i++)
        {
            ...
            if (beforePos->next == *Head) // to handel the condition if iPos > no. nodes in linked list
            {
        ...
        Pos = beforePos->next;
        afterPos = beforePos->next->next;

        if (afterPos == *Head)   // @ iPos node not exists
        {
